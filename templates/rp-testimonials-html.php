	...
	<div class="row">
		...
		<div class="col-md-4">
			<select class="form-control" id="rp-sort-select">
				<option value="" disabled selected><?php esc_html_e( '-- Sort By --', RP_TEXT_DOMAIN ); ?></option>
				<option value="DESC" class="rp-sort-option" onhover="setOption"><?php esc_html_e( 'Newest First', RP_TEXT_DOMAIN ); ?></option>
				<option value="ASC" class="rp-sort-option" onhover="setOption"><?php esc_html_e( 'Oldest First', RP_TEXT_DOMAIN ); ?></option>
			</select>
		</div>
	</div>
</nav>
<div id="cards-container" class="row">
	<?php esc_html_e( 'Loading...', RP_TEXT_DOMAIN ); ?>
</div>
